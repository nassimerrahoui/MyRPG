...
public class GeneratePersonnage {
    ...
    public static void createPersonnagesControlables(GameView v, Vector<Vector<Cell>> cells, int levelId) {
        ...
        if(levelId == 0) {
            Bitmap p1_bmp = BitmapFactory.decodeResource(v.getResources(), R.drawable.char1_right);
            Bitmap mutable_p1_bmp = p1_bmp.copy(Bitmap.Config.ARGB_8888, true);
            Bitmap p1_bmp2 = BitmapFactory.decodeResource(v.getResources(), R.drawable.char1_right);
            ...
            Bitmap p2_bmp = BitmapFactory.decodeResource(v.getResources(), R.drawable.man4_lf1);
            Bitmap mutable_p2_bmp = p2_bmp.copy(Bitmap.Config.ARGB_8888, true);
            Bitmap p2_bmp2 = BitmapFactory.decodeResource(v.getResources(), R.drawable.man4_lf1);
    ...
    public static void createPersonnagesIncontrolables(GameView v, Vector<Vector<Cell>> cells, int levelId) {
        ...
        if(levelId == 0) {
            Bitmap p2_bmp = BitmapFactory.decodeResource(v.getResources(), R.drawable.incontrolable);
            Bitmap mutable_p2_bmp = p2_bmp.copy(Bitmap.Config.ARGB_8888, true);
            Bitmap p2_bmp2 = BitmapFactory.decodeResource(v.getResources(), R.drawable.incontrolable_2);
            ...
            Bitmap p4_bmp = BitmapFactory.decodeResource(v.getResources(), R.drawable.incontrolable);
            Bitmap mutable_p4_bmp = p4_bmp.copy(Bitmap.Config.ARGB_8888, true);
            Bitmap p4_bmp2 = BitmapFactory.decodeResource(v.getResources(), R.drawable.incontrolable_2);
